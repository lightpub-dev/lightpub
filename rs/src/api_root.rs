...
pub async fn user_create_follow(
...
pub async fn user_delete_follow(
    path: web::Path<UserChooseParams>,
    data: web::Data<AppState>,
    auth: AuthUser,
) -> Result<impl Responder, ErrorResponse> {
...
#[get("/nodeinfo/2.0")]
pub async fn node_info_2_0(app: web::Data<AppState>) -> impl Responder {
...
#[get("/nodeinfo/2.1")]
pub async fn node_info_2_1(app: web::Data<AppState>) -> impl Responder {
    let config = app.config();
...
pub async fn well_known_node_info(app: web::Data<AppState>) -> impl Responder {
...
pub async fn host_meta(app: web::Data<AppState>) -> HandlerResponse<impl Responder> {
    let base_url = app.base_url();
    let xml = r#"
...
#[delete("/post/{post_id}")]
pub async fn delete_single_post(
    app: web::Data<AppState>,
    path: web::Path<PostChooseParams>,
    auth: AuthUser,
) -> HandlerResponse<impl Responder> {
...
pub async fn add_post_favorite(
    app: web::Data<AppState>,
    path: web::Path<PostChooseParams>,
    auth: AuthUser,
) -> HandlerResponse<impl Responder> {
...
pub async fn add_post_bookmark(
    app: web::Data<AppState>,
    path: web::Path<PostChooseParams>,
    auth: AuthUser,
) -> HandlerResponse<impl Responder> {
...
pub async fn delete_post_favorite(
    app: web::Data<AppState>,
    path: web::Path<PostChooseParams>,
    auth: AuthUser,
) -> HandlerResponse<impl Responder> {
...
pub async fn modify_post_reaction(
    app: web::Data<AppState>,
    path: web::Path<PostChooseParams>,
...
#[post("/debug/truncate")]
pub async fn truncate_database(app: web::Data<AppState>) -> impl Responder {
    let table_names = [
        "users",
        "posts",
        "uploaded_files",
